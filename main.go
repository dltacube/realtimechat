...
func wsPage(res http.ResponseWriter, req *http.Request) {
	...
	// blank identifiers avoid the declared but unused errors
	// changes in the uuid API require picking up a potential error code
	// https://stackoverflow.com/questions/21743841/how-to-avoid-annoying-error-declared-and-not-used-from-golang
	// https://github.com/hlandau/acme/issues/293
	u, _ := uuid.NewV4()
